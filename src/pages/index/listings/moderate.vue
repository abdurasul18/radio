...
<template>
  <div>
            ...
            <div class="px-4 pt-3 pb-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-1 text-gray-400 text-sm">
                  ...
                  <CIconButton icon="edit" @click.stop="
                    $router.push(
              ...
              <div class="grid gap-2 mt-3">
                <CButton size="small" :loading="currentItem?.id == item.id && acceptLoading" icon="check"
                  @click.stop="acceptItem(item)">
                  Qabul qilish
                </CButton>
                <CButton size="small" type="error" icon="times" :loading="currentItem?.id == item.id && rejectLoading"
                  @click.stop="
                    currentItem = item;
                  rejectShow = true;
                  ">
    ...
    <CModal v-model:show="rejectShow" title="Rad qilish sababi" class="max-w-[450px]">
      <CInput v-model:value="rejectReason" type="textarea" placeholder="Rad qilish sababini kiriting" />
